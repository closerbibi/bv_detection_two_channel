...
resultpath = '../results/train/comp4-18196_det_train_chair.txt' # train
#resultpath = '../results/test/comp4-27463_det_test_toilet.txt'
gt_path = '../data/DIRE/Annotations/'
sceneimgpath = '../SUNRGBD/kv1/NYUdata/'
#layerimgpath = '/home/closerbibi/bin/faster-rcnn/data/DIRE/ImagesNoRankPooling/'
layerimgpath = '../SUNRGBD/SUNRGBDtoolbox/SUNRGBDtoolbox/slicedData/picture_forPooling/'
